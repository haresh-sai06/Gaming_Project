const Hero = () => {
  return (
    <main className="relative w-full h-screen overflow-hidden flex justify-center mb-[10%]">
        <video src="public\videos\hero.mp4" autoPlay loop muted playsInline className="w-full h-[95%] object-cover absolute top-0 left-0 -z-10"></video>
        <div className="absolute bottom-[15%] flex flex-col items-center gap-5">
            ...
            <p className="max-w-[80%] text-center text-[#baba]">
                Notice: This is a demo website only.
            </p>
        </div> 
